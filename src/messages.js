...
export default defineMessages({
  ...
  Text_Common_OperationFailed: {
    id: "Text-Common-OperationFailed",
    defaultMessage: "操作失敗",
  },
  Text_Common_Required: {
    id: "Text-Common-Required",
    defaultMessage: "此欄位不可為空白",
  },
  Text_Common_RequiredHint: {
  ...
  Text_SingleScreen_VideoPlaySuccess: {
    ...
    defaultMessage: "影像來源 [{source}] 已投放至 [{destination}]",
  },
  ...
  Text_SingleScreen_VideoClearSuccess: {
    ...
    defaultMessage: "完成清除顯示終端 [{destination}] 當前投放影像",
  },
