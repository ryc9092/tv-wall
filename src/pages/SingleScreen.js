...
const SingleScreen = () => {
  ...
  useEffect(() => {
    (async () => {
      ...
      const encoders = [{
        "nickName": "Zyper4KE1",
        "mac": "80:1f:12:4d:82:ee",
        "model": "Zyper4K",
        "type": "encoder",
        "virtualType": "",
        "name": "80:1f:12:4d:82:ee__192.168.0.31__80:1f:12:4d:82:ee",
        "state": "Up",
        "productCode": "",
        "productDescription": "",
        "pid": "",
        "groupId": "-1",
        "groupName": "",
        "previewUrl": "http://192.168.0.31:8080/?action=stream\u0026w=1280\u0026h=720\u0026fps=15\u0026bw=5000\u0026as=0",
        "audioHdmi": "HDMI",
